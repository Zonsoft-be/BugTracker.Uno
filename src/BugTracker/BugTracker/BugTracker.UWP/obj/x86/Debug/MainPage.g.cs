#pragma checksum "C:\Repos\GitHub\BugTracker.Uno\src\BugTracker\BugTracker\BugTracker.Shared\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "8C2517007C6012281DC81E0CC032550E"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace BugTracker
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::BugTracker.MainPage dataRoot;
            ...
            {
                if (lineNumber == 37 && columnNumber == 18)
                {
                    isobj2TextDisabled = true;
                }
                else if (lineNumber == 70 && columnNumber == 20)
                {
                ...
                else if (lineNumber == 62 && columnNumber == 15)
                {
                ...
                else if (lineNumber == 50 && columnNumber == 26)
                {
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::BugTracker.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            {
                global::BugTracker.Models.IssueItem obj;
            ...
            private bool TryGet_Item(out global::BugTracker.Models.IssueItem val)
            {
                global::BugTracker.MainPage obj;
                ...
                {
                    val = default(global::BugTracker.Models.IssueItem);
                    return false;
                }
            }

            private bool TryGet_(out global::BugTracker.MainPage val)
            {
                val = this.dataRoot;
                return true;
            }
            ...
            private void Invoke_M_FormatDate_2480369986(int phase)
            {
            ...
            private void Invoke_M_FormatDate_1540338105(int phase)
            {
            ...
            private void Invoke_M_FormatDate_2702426981(int phase)
            {
            ...
            private void Update_(global::BugTracker.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    {
                        this.Update_M_FormatDate_2480369986(phase);
                        this.Update_StatusList(obj.StatusList, phase);
                    }
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_M_FormatDate_1540338105(phase);
                        this.Update_M_FormatDate_2702426981(phase);
                    }
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
            ...
            private void Update_Item(global::BugTracker.Models.IssueItem obj, int phase)
            {
            ...
            private void Update_M_FormatDate_2480369986(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    if (!isobj3TextDisabled)
                    {
                        this.PendingFunctionBindings["M_FormatDate_2480369986"] = new InvokeFunctionDelegate(this.Invoke_M_FormatDate_2480369986); 
                    }
                }
            }
            private void Update_StatusList(global::BugTracker.Models.IssueStatus[] obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Item_Status(global::BugTracker.Models.IssueStatus obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // MainPage.xaml line 61
            ...
            private void Update_M_FormatDate_1540338105(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    if (!isobj5TextDisabled)
                    {
                        this.PendingFunctionBindings["M_FormatDate_1540338105"] = new InvokeFunctionDelegate(this.Invoke_M_FormatDate_1540338105); 
                    }
                }
            }
            ...
            private void Update_M_FormatDate_2702426981(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    if (!isobj6TextDisabled)
                    {
                        this.PendingFunctionBindings["M_FormatDate_2702426981"] = new InvokeFunctionDelegate(this.Invoke_M_FormatDate_2702426981); 
                    }
                }
            }
            ...
            private void Update_IssueTypeList(global::BugTracker.Models.IssueType[] obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Item_Type(global::BugTracker.Models.IssueType obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // MainPage.xaml line 28
            ...
            private void UpdateTwoWay_11_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.Item != null)
                        {
                            this.dataRoot.Item.Type = (global::BugTracker.Models.IssueType)this.obj11.SelectedItem;
                        }
                    }
                }
            }
            ...
            private class MainPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_Item(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::BugTracker.Models.IssueItem obj = sender as global::BugTracker.Models.IssueItem;
                ...
                private global::BugTracker.Models.IssueItem cache_Item = null;
                public void UpdateChildListeners_Item(global::BugTracker.Models.IssueItem obj)
                {
                    if (obj != cache_Item)
                    {
                        if (cache_Item != null)
